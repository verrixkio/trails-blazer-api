...
RSpec.describe NewTrailsController, type: :controller do
  ...
  describe "POST #create" do
    context "with valid params" do
      ...
      it "renders a JSON response with the new new_trail" do

        post :create, params: {new_trail: valid_attributes}, session: valid_session
        expect(response).to have_http_status(:created)
        expect(response.content_type).to eq('application/json')
        expect(response.location).to eq(new_trail_url(NewTrail.last))
      end
    end

    context "with invalid params" do
      it "renders a JSON response with errors for the new new_trail" do
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "renders a JSON response with the new_trail" do
        new_trail = NewTrail.create! valid_attributes
    ...
    context "with invalid params" do
      it "renders a JSON response with errors for the new_trail" do
        new_trail = NewTrail.create! valid_attributes
